...
class PluginFormcreatorRulePool extends CommonDropdown
{
    ...
    {
        return _n('Rules pool', 'Rules pools', $nb, 'formcreator');
    }
...
//            </a>';
        echo '<a href="javascript:addRulesPool(' . $item->getID() . ', \'' . $token . '\', ' . $i . ');">
                <img src="' . $CFG_GLPI['root_doc'] . '/pics/menu_add.png" alt="+" align="absmiddle" />
                ' . __('Add a rules pool', 'formcreator') . '
            </a>';
        echo '</td>';
        echo '</tr>';
    ...
    public function showSubForm() {
        ...
        echo '<tr><th colspan="8">'.__('Add a rules pool', 'formcreator').'</th></tr>';
        ...
        echo '<td width="5%"><strong>'.__('Description').'</strong></td>';
        echo '<td width="60%"><input type="text" name="description" style="width:90%;" value="" /></td>';
